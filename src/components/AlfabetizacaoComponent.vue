    ...
    <div class="margin">
     <div class="zenith-container">
       ...
       <div class="card" @click="openCarousel">
         <img
           :src="require('@/assets/Images/Card02/Alfabetizacao (1).jpeg')"
           alt="Sacolao"
           class="card-image"
         />
...
Por meio de metodologias interativas, materiais adequados e o carinho de nossos educadores, estamos formando cidadãos mais conscientes e preparados para superar os desafios da vida. Junte-se a nós nessa missão de transformar vidas por meio da educação!
   ...
   <script>
   export default {
     name: "AlfabetizacaoComponent",
     data() {
       return {
         galleryImages: [  
       require('@/assets/Images/Card02/Alfabetizacao (1).jpeg'),
       require('@/assets/Images/Card02/Alfabetizacao (2).jpeg'),
       require('@/assets/Images/Card02/Alfabetizacao (3).jpeg'),
       require('@/assets/Images/Card02/Alfabetizacao (4).jpeg'),
