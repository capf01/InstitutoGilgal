<template>
  ...
  export default {
    ...
    setup() {
      ...
      new URL('@/assets/Images/OficinadeLeitura (2).jpeg', import.meta.url).href,  
      new URL('@/assets/Images/OficinadeLeitura.jpeg', import.meta.url).href, 
      new URL('@/assets/Images/GigalAmbiental.jpeg', import.meta.url).href,
      new URL('@/assets/Images/Capoeira (1).jpeg', import.meta.url).href,
      new URL('@/assets/Images/Capoeira (2).jpeg', import.meta.url).href,
      new URL('@/assets/Images/Capoeira (3).jpeg', import.meta.url).href,
      new URL('@/assets/Images/Informatica (1).jpeg', import.meta.url).href,
      new URL('@/assets/Images/Informatica (2).jpeg', import.meta.url).href,
      new URL('@/assets/Images/Sacolao.jpeg', import.meta.url).href,
    ];
