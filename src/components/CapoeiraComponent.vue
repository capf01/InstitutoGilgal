    ...
    <div class="margin">
     <div class="zenith-container">
       ...
       <div class="card" @click="openCarousel">
         <img
           :src="require('@/assets/Images/Card04/Capoeira (1).jpeg')"
           alt="Capoeria"
           class="card-image"
         />
...
Com o Projeto Capoeira, o Instituto Gilgal busca empoderar cada participante, mostrando que, com esforço e determinação, é possível superar qualquer obstáculo. Venha fazer parte desse movimento de transformação e celebração da cultura!
   ...
   <script>
   export default {
     name: "CapoeiraComponent",
     data() {
       return {
         galleryImages: [  
       require('@/assets/Images/Card04/Capoeira (1).jpeg'),
       require('@/assets/Images/Card04/Capoeira (2).jpeg'),
       require('@/assets/Images/Card04/Capoeira (3).jpeg'),
       require('@/assets/Images/Card04/Capoeira (4).jpeg'),
